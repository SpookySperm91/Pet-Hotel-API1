...
public class ActivityLogDomain {
    ...
    public static ActivityLogDomain create(ActivityLogType activityType, String petOwner, String pet, String description) {
        return new ActivityLogDomain(null, null, activityType, "Admin", petOwner, pet, description, Instant.now());
    }
    ...
    public static ActivityLogDomain createForRequest(RequestDomain request, ActivityLogType activityType, String petOwner, String pet) {
        ...
        return new ActivityLogDomain(null, request.getId(), activityType, "Admin", petOwner, pet, request.getResponseMessage(), Instant.now());
    }
